...
public class EyeTrackingAlternative : MonoBehaviour
{
    ...
    [Header("Blend Shape Names (Alternative Standard)")]
    // Left Eye
    public string L_LookUp = "Eye_L_Look_Up";
    public string L_LookDown = "Eye_L_Look_Down";
    public string L_LookLeft = "Eye_L_Look_L";
    public string L_LookRight = "Eye_L_Look_R";

    // Right Eye
    public string R_LookUp = "Eye_R_Look_Up";
    public string R_LookDown = "Eye_R_Look_Down";
    public string R_LookLeft = "Eye_R_Look_L";
    public string R_LookRight = "Eye_R_Look_R";
    ...
    void Start()
    {
        ...
        if (headBone == null)
        {
            ...
            if (headBone == null) Debug.LogWarning("EyeTrackingAlternative: Head bone not found/assigned. Calculations will be wrong.");
        }
