...
/// Responsible for populating the first page of the notebook with victim and crime scene data.
/// </summary>
public class NotebookManager : MonoBehaviour
{
    ...
    public void PopulateVictimPage()
    {
        ...
        // Populate text fields with labeled values if they are assigned in the inspector
        ...
        Debug.Log("Notebook Page 1 (Victim File) has been updated successfully.");
    }
